...
@useResult
$Res call({
 String id, TypeProgramme type, DateTime date, String location, String? idAssembleeLocale, String? description, String? observations, List<String> participantIds, TypeVisite? typeVisite, int? nombreHommes, int? nombreFemmes, int? nombreGarcons, int? nombreFilles, int? conversionsHommes, int? conversionsFemmes, int? conversionsGarcons, int? conversionsFilles, int? nombreClassesEcoleDuDimanche, int? nombreMoniteursHommes, int? nombreMonitricesFemmes, String? derniereLeconEcoleDuDimanche, String? compteRenduVisite
});
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  TypeProgramme type,  DateTime date,  String location,  String? idAssembleeLocale,  String? description,  String? observations,  List<String> participantIds,  TypeVisite? typeVisite,  int? nombreHommes,  int? nombreFemmes,  int? nombreGarcons,  int? nombreFilles,  int? conversionsHommes,  int? conversionsFemmes,  int? conversionsGarcons,  int? conversionsFilles,  int? nombreClassesEcoleDuDimanche,  int? nombreMoniteursHommes,  int? nombreMonitricesFemmes,  String? derniereLeconEcoleDuDimanche,  String? compteRenduVisite)  $default,) {final _that = this;
switch (_that) {
case _Program():
return $default(_that.id,_that.type,_that.date,_that.location,_that.idAssembleeLocale,_that.description,_that.observations,_that.participantIds,_that.typeVisite,_that.nombreHommes,_that.nombreFemmes,_that.nombreGarcons,_that.nombreFilles,_that.conversionsHommes,_that.conversionsFemmes,_that.conversionsGarcons,_that.conversionsFilles,_that.nombreClassesEcoleDuDimanche,_that.nombreMoniteursHommes,_that.nombreMonitricesFemmes,_that.derniereLeconEcoleDuDimanche,_that.compteRenduVisite);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  TypeProgramme type,  DateTime date,  String location,  String? idAssembleeLocale,  String? description,  String? observations,  List<String> participantIds,  TypeVisite? typeVisite,  int? nombreHommes,  int? nombreFemmes,  int? nombreGarcons,  int? nombreFilles,  int? conversionsHommes,  int? conversionsFemmes,  int? conversionsGarcons,  int? conversionsFilles,  int? nombreClassesEcoleDuDimanche,  int? nombreMoniteursHommes,  int? nombreMonitricesFemmes,  String? derniereLeconEcoleDuDimanche,  String? compteRenduVisite)?  $default,) {final _that = this;
switch (_that) {
case _Program() when $default != null:
return $default(_that.id,_that.type,_that.date,_that.location,_that.idAssembleeLocale,_that.description,_that.observations,_that.participantIds,_that.typeVisite,_that.nombreHommes,_that.nombreFemmes,_that.nombreGarcons,_that.nombreFilles,_that.conversionsHommes,_that.conversionsFemmes,_that.conversionsGarcons,_that.conversionsFilles,_that.nombreClassesEcoleDuDimanche,_that.nombreMoniteursHommes,_that.nombreMonitricesFemmes,_that.derniereLeconEcoleDuDimanche,_that.compteRenduVisite);case _:
  return null;
...
class _Program extends Program {
  const _Program({required this.id, required this.type, required this.date, required this.location, this.idAssembleeLocale, this.description, this.observations, final  List<String> participantIds = const [], this.typeVisite, this.nombreHommes, this.nombreFemmes, this.nombreGarcons, this.nombreFilles, this.conversionsHommes, this.conversionsFemmes, this.conversionsGarcons, this.conversionsFilles, this.nombreClassesEcoleDuDimanche, this.nombreMoniteursHommes, this.nombreMonitricesFemmes, this.derniereLeconEcoleDuDimanche, this.compteRenduVisite}): _participantIds = participantIds,super._();
